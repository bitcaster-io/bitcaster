...
class TeleBot(object):
    ...
    def forward_message(self):
        raise NotImplementedError('forward_message needs work')

    def send_photo(self):
        raise NotImplementedError('send_photo needs work')

    def send_audio(self):
        raise NotImplementedError('send_audio needs work')

    def send_document(self):
        raise NotImplementedError('send_document needs work')

    def send_sticker(self):
        raise NotImplementedError('send_sticker needs work')

    def send_video(self):
        raise NotImplementedError('send_video needs work')

    def send_location(self):
        raise NotImplementedError('send_location needs work')

    def send_chat_action(self):
        raise NotImplementedError('send_chat_action needs work')

    def get_user_profile_photos(self):
        raise NotImplementedError('get_user_profile_photos needs work')
    ...
    def set_webhook(self):
        raise NotImplementedError('set_webhook needs work')

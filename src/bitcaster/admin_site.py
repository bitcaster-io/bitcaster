...
class ConsoleAdminSite(UnfoldAdminSite):
    site_title = gettext_lazy("Bitcaster console")

    def autodiscover(self):
        autodiscover_modules("console", register_to=self)

        # from bitcaster.admin.address import Address, AddressAdmin
        # from bitcaster.admin.user import User, UserAdmin
        # self.register(Address, AddressAdmin)

...
from .views import (AddressAutocomplete, ApplicationAutocomplete,
                    ApplicationCandidateAutocomplete,
                    ApplicationCheckConfigView, ApplicationCreate,
                    ApplicationDashboard, ApplicationDeleteView,
                    ApplicationInvitationDelete, ApplicationInvitationSend,
                    ApplicationInvite, ApplicationKeyCreate,
                    ApplicationKeyDelete, ApplicationKeyList,
                    ApplicationKeyUpdate, ApplicationLog,
                    ApplicationMembersAutocomplete, ApplicationMembershipCreate,
                    ApplicationMembershipDelete, ApplicationMembershipEdit,
                    ApplicationMembershipList, ApplicationMonitorCreate,
                    ApplicationMonitorList, ApplicationMonitorRemove,
                    ...
                    ApplicationTeamMember, ApplicationTeamMemberRemove,
                    ...
                    OrganizationApplications, OrganizationAuditLogView,
                    ...
                    OrganizationDashboard, OrganizationGroupApplications,
                    OrganizationGroupCreate, OrganizationGroupDelete,
                    OrganizationGroupEdit, OrganizationGroupList,
                    OrganizationGroupMemberRemove, OrganizationGroupMembers,
                    ...
                    OrganizationMembershipList, OrganizationNotificationLogView,
                    OrgInviteDelete, OrgInviteSend, PluginInfo,
                    SettingsBackupRestore, SettingsEmailView, SettingsLdapView,
                    SettingsOAuthView, SettingsPlugin, SettingsPluginRefresh,
                    SettingsPluginToggle, SettingsSystemInfo, SettingsView,
                    SetupView, UserAddressesAssignmentView,
                    UserAddressesInfoView, UserAddressesVerifyView,
                    UserAddressesView, UserApplicationListView,
                    UserAutocomplete, UserEventListView, UserEventSubcribe,
                    UserHome, UserProfileView, UserSubscriptionEdit,
...
urlpatterns = [
    ...
    path('<slug:org>/me/assignment/<int:pk>/resend/', UserAddressesVerifyView.as_view(mode='resend'),
         name='user-address-resend'),
    path('<slug:org>/me/assignment/<int:pk>/verify/', UserAddressesVerifyView.as_view(mode='form'),
    ...
    path('<slug:org>/a/<slug:app>/member/<int:pk>/delete/', ApplicationMembershipDelete.as_view(),
    ...
    path('<slug:org>/log/', OrganizationNotificationLogView.as_view(), name='org-log'),
    path('<slug:org>/audit/', OrganizationAuditLogView.as_view(), name='org-auditlog'),
    ...
    path('<slug:org>/group/<int:group>/members/<int:member>/remove/', OrganizationGroupMemberRemove.as_view(),
...
urlpatterns += [
    ...
    path('dal/<slug:org>/application-autocomplete/', ApplicationAutocomplete.as_view(),
         name='application-autocomplete'),
    path('dal/<slug:org>/members-autocomplete/', OrganizationMembersAutocomplete.as_view(),
         name='org-member-autocomplete'),

    path('dal/<slug:org>/a/<slug:app>/members-autocomplete/', ApplicationMembersAutocomplete.as_view(),
         name='app-member-autocomplete'),
    path('dal/<slug:org>/a/<slug:app>/candidate-autocomplete/', ApplicationCandidateAutocomplete.as_view(),

...
from .views import (ApplicationChannelCreate, ApplicationChannelDeprecate,
                    ...
                    OrganizationMembers, OrganizationUpdate, PluginInfo,
                    ...
                    UserWelcomeView, WorkInProgressView, confirm_email, OrganizationTeamList, OrganizationTeamCreate)
...
urlpatterns = [
    ...
    path('<slug:org>/<slug:app>/channel/<int:pk>/delete/', ApplicationChannelRemove.as_view(),
         name='app-channel-delete'),
    path('<slug:org>/<slug:app>/channel/<int:pk>/toggle/', ApplicationChannelToggle.as_view(),
         name='app-channel-toggle'),
    path('<slug:org>/<slug:app>/channel/<int:pk>/deprecate/', ApplicationChannelDeprecate.as_view(),

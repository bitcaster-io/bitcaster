...
from .views import (ApplicationChannelCreate,  # UserHomeView,; UserWelcomeView,
                    ApplicationChannelDeprecate, ApplicationChannelRemove,
                    ApplicationChannels, ApplicationChannelToggle,
                    ApplicationChannelUpdate, ApplicationCheckConfigView,
                    ...
                    OrganizationCreate, OrganizationCreateMember,
...
urlpatterns = [
    ...
    path('<slug:org>/a/<slug:app>/key/<int:pk>/edit/', ApplicationKeyUpdate.as_view(), name='app-key-update'),

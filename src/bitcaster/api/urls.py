...
urlpatterns = [
    ...
    path("o/<slug:org>/c/", ChannelView.as_view({"get": "list"}), name="org-channel-list"),
    #
    ...
    path("o/<slug:org>/p/<slug:prj>/c/", ChannelView.as_view({"get": "list"}), name="project-channel-list"),
    #
    #
    path(

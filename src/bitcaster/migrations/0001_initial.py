    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, on_delete=django.db.models.deletion.CASCADE, to="bitcaster.organization"
            ),
        ),
        migrations.CreateModel(
            name="Project",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("name", models.CharField(db_collation="case_insensitive", max_length=255)),
                ("project", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="bitcaster.project")),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name="project",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="bitcaster.project"
            ),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hidden",
                    models.BooleanField(
                        default=False, help_text="Do not show this subscription in the informative page"
                    ),
                ),
                (
                    "distribution",
        ...
        migrations.AddField(
            ...
            name="recipients",
            field=models.ManyToManyField(to="bitcaster.validation"),
        ),
